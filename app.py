...
def basic_search_result():
    ...
    return render_template('basic_search_result.html',prediction=prediction,manufacturer_list=manufacturer_list,price_list=price_list)
...
def advanced_search_result2():
    ...
    manufacturer_list=[df[df['product_name']==manufacturer]['manufacturer'].values[0] for manufacturer in prediction]
    price_list=[df[df['product_name']==price]['price_tag'].values[0] for price in prediction]
    return render_template('advanced_search_result2.html',prediction=prediction,manufacturer_list=manufacturer_list,price_list=price_list)
